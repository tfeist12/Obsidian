...
To do:
- Refresh is being triggered when I was hoping to hit an update 
- Add messages to important condition updates
- Need to deal with the ready state -> use pending update
- Use inactive firmware version field instead of 