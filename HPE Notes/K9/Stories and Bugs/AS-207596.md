...
- Error state handler -> use a timeout
- Remove unknown state. Keep reporting current state until a state change or timeout
- Set Conditions in refresh as we would for real firmware update